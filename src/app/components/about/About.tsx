  ...
  return (
    <div className="about-wrapper">
      <div className="about-content-wrapper">
        <img className="about-profile-image" src={AboutProfile} alt="profile-image"></img>
        <div className="about-content">
          <div className="about-title">
            <div>A Brief Summary of Me</div>
          </div>
          <div className="about-text">
            ...
            <p className="paragraph">
              ...
              game, Minecraft in my free time outside of school. The server running my code went on
              to become one of the top 5 servers worldwide by number of concurrent players. It was
              at this time that my &apos;code-brain&apos; unlocked, and I knew there and then that
              this was what I was meant to do.
            </p>
            <p className="paragraph">
              I have a passion for learning and extreme drive for success. Programming has become a
              large part of my life; I find great pleasure in learning about, designing,
